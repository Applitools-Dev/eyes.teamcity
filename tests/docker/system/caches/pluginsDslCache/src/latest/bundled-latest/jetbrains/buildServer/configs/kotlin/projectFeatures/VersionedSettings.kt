 ...
 * This project feature is created only for projects with obsolete [non-portable Kotlin DSL](https://www.jetbrains.com/help/teamcity/?Kotlin+DSL#Non-Portable+DSL).
 *
 * **Example.**
 * Adds a [versioned settings](https://www.jetbrains.com/help/teamcity/?Storing+Project+Settings+in+Version+Control) project feature
 * for project with obsolete [non-portable Kotlin DSL](https://www.jetbrains.com/help/teamcity/?Kotlin+DSL#Non-Portable+DSL).
 * ```
 * versionedSettings {
