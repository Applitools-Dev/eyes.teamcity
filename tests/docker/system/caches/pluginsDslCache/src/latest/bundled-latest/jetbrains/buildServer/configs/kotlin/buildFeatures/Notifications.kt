 ...
 *
 * **Example.**
 * Adds notifications build feature that sends email notifications when build is started
 * ```
 * notifications {
 ...
 *
 * **Example.**
 * Adds notifications build feature that sends email notifications when build is finished successfully
 * ```
 * notifications {
 *     notifierSettings = emailNotifier {
 *         email = "me@mail.com"
 ...
 *
 * **Example.**
 * Adds notifications build feature that sends email notifications when build failed, but only in "main" branch
 * ```
 * notifications {
 *     notifierSettings = emailNotifier {
 *         email = "me@mail.com"
