 ...
 *
 * **Example.**
 * Defines a Subversion VCS root MyVcsRoot with authentication by an SSH key and registers it in the project and a build configuration.
 * The VCS Root fully supports SVN externals.
 * ```
 * project {
 *   ...
 *   vcsRoot(MyVcsRoot)
