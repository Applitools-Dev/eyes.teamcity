...
open class Swabra : BuildFeature {
    constructor(init: Swabra.() -> Unit = {}, base: Swabra? = null): super(base = base as BuildFeature?) {
        type = "swabra"
        init()
    }
 ...
 * @see Swabra
 */
fun BuildFeatures.swabra(base: Swabra? = null, init: Swabra.() -> Unit = {}) {
    feature(Swabra(init, base))
}
