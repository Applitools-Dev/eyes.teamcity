...
open class GradleBuildStep : BuildStep {
    constructor(init: GradleBuildStep.() -> Unit = {}, base: GradleBuildStep? = null): super(base = base as BuildStep?) {
        type = "gradle-runner"
        init()
    }
 ...
 * @see GradleBuildStep
 */
fun BuildSteps.gradle(base: GradleBuildStep? = null, init: GradleBuildStep.() -> Unit = {}) {
    step(GradleBuildStep(init, base))
}
