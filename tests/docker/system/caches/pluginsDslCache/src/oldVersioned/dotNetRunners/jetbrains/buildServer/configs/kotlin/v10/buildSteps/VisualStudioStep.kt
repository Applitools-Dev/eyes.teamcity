...
/**
 * Deprecated, was previously used to set up a [build step for running a Visual Studio solution](https://www.jetbrains.com/help/teamcity/visual-studio-sln.html).
 * Use the [.NET Devenv runner](https://www.jetbrains.com/help/teamcity/kotlin-dsl-documentation/buildSteps/devenv-build-step/index.html) instead.
 * See [this link](https://www.jetbrains.com/help/teamcity/net.html#migrating-to-net-from-sln) for more information on migrating from the Visual Studio (sln) runner.
 *
 *
 * @see visualStudio
 */
@Deprecated("Deprecated, was previously used to set up a build step for running a Visual Studio solution.", replaceWith = ReplaceWith("DevenvBuildStep"))
open class VisualStudioStep : BuildStep {
    constructor(init: VisualStudioStep.() -> Unit = {}, base: VisualStudioStep? = null): super(base = base as BuildStep?) {
        type = "VS.Solution"
        init()
    }
 ...
 */
@Deprecated("Deprecated, was previously used to set up a build step for running a Visual Studio solution.", replaceWith = ReplaceWith("DevenvBuildStep"))
fun BuildSteps.visualStudio(base: VisualStudioStep? = null, init: VisualStudioStep.() -> Unit = {}) {
    step(VisualStudioStep(init, base))
}
