 ...
 *
 * **Example.**
 * Runs [MSpec](https://github.com/machine/machine.specifications) tests with help of the MSpec executable located on the agent at the specified path.
...
open class MSpecStep : BuildStep {
    constructor(init: MSpecStep.() -> Unit = {}, base: MSpecStep? = null): super(base = base as BuildStep?) {
 ...
 * @see MSpecStep
 */
fun BuildSteps.mspec(base: MSpecStep? = null, init: MSpecStep.() -> Unit = {}) {
    step(MSpecStep(init, base))
}
