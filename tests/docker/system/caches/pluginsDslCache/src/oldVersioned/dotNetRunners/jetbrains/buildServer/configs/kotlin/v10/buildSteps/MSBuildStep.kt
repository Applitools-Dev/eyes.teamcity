...
/**
 * Deprecated, was previously used to set up a [build step for running an MSBuild script](https://www.jetbrains.com/help/teamcity/msbuild.html).
 * Use the [.NET MSBuild runner](https://www.jetbrains.com/help/teamcity/kotlin-dsl-documentation/buildSteps/dotnet-ms-build-step/index.html) instead.
 * See [this link](https://www.jetbrains.com/help/teamcity/net.html#Migrating+from+MSBuild+Runner) for more information on migrating to the .NET MSBuild runner.
 *
 *
 * @see msBuild
 */
@Deprecated("Deprecated, was previously used to set up a build step for running an MSBuild script.", replaceWith = ReplaceWith("DotnetMsBuildStep"))
open class MSBuildStep : BuildStep {
    constructor(init: MSBuildStep.() -> Unit = {}, base: MSBuildStep? = null): super(base = base as BuildStep?) {
        type = "MSBuild"
        init()
    }

    /**
     * [Build working directory](https://www.jetbrains.com/help/teamcity/?Build+Working+Directory) for the Ant script.
     * Specify a working directory if it differs from the [checkout directory](https://www.jetbrains.com/help/teamcity/?Build+Checkout+Directory).
     */
    ...
    enum class MSBuildVersion {
        ...
        companion object {
            val mapping = mapOf<MSBuildVersion, String>(V17_0 to "17.0", V16_0 to "16.0", V15_0 to "15.0", V14_0 to "14.0", V12_0 to "12.0", V4_5 to "4.5", V4_0 to "4.0", V3_5 to "3.5", V2_0 to "2.0", MONO_v4_5 to "mono_4.5", MONO_v4_0 to "mono_4.0", MONO_v3_5 to "mono_3.5", MONO_v2_0 to "mono")
        }
    ...
    enum class MSBuildToolsVersion {
        ...
        companion object {
            val mapping = mapOf<MSBuildToolsVersion, String>(NONE to "none", V16_0 to "Current", V15_0 to "15.0", V14_0 to "14.0", V12_0 to "12.0", V4_0 to "4.0", V3_5 to "3.5", V2_0 to "2.0")
        }
...
/**
 * Adds a [build step](https://www.jetbrains.com/help/teamcity/msbuild.html) running MSBuild script
 *
 *
 * @see MSBuildStep
 */
@Deprecated("Deprecated, was previously used to set up a build step for running an MSBuild script.", replaceWith = ReplaceWith("DotnetMsBuildStep"))
fun BuildSteps.msBuild(base: MSBuildStep? = null, init: MSBuildStep.() -> Unit = {}) {
    step(MSBuildStep(init, base))
}
