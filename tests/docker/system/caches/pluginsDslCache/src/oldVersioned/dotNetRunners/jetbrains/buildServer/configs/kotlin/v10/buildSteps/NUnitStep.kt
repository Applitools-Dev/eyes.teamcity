...
open class NUnitStep : BuildStep {
    constructor(init: NUnitStep.() -> Unit = {}, base: NUnitStep? = null): super(base = base as BuildStep?) {
        type = "NUnit"
 ...
 * @see NUnitStep
 */
fun BuildSteps.nunit(base: NUnitStep? = null, init: NUnitStep.() -> Unit = {}) {
    step(NUnitStep(init, base))
}
