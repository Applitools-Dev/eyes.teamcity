...
open class ReSharperInspections : BuildStep {
    constructor(init: ReSharperInspections.() -> Unit = {}, base: ReSharperInspections? = null): super(base = base as BuildStep?) {
    ...
    var targetDotNetFramework_4_8_1 by booleanParameter("TargetDotNetFramework_4.8.1", trueValue = "true", falseValue = "")
 ...
 * @see ReSharperInspections
 */
fun BuildSteps.reSharperInspections(base: ReSharperInspections? = null, init: ReSharperInspections.() -> Unit = {}) {
    step(ReSharperInspections(init, base))
}
