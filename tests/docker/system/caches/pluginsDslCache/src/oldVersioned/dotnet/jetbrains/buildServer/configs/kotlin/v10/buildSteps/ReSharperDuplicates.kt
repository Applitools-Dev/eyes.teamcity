 ...
 */
@Deprecated("Deprecated, was previously used to set up a Duplicates finder (ReSharper) build step.")
open class ReSharperDuplicates : BuildStep {
    constructor(init: ReSharperDuplicates.() -> Unit = {}, base: ReSharperDuplicates? = null): super(base = base as BuildStep?) {
 ...
 */
@Deprecated("Deprecated, was previously used to set up a Duplicates finder (ReSharper) build step.")
fun BuildSteps.reSharperDuplicates(base: ReSharperDuplicates? = null, init: ReSharperDuplicates.() -> Unit = {}) {
    step(ReSharperDuplicates(init, base))
}
