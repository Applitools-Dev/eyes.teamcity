 ...
 *
 * **Example.**
 * Fail build if text "ERROR" appears in the build log.
 * ```
 * failOnText {
 ...
 *
 * **Example.**
 * Fail build if the build log text matches some regexp. Also stops the build as soon as the failure is detected.
 * ```
 * failOnText {
