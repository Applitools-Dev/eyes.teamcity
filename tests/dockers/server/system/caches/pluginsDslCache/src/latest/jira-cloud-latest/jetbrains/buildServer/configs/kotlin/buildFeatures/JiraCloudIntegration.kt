 ...
 *
 * **Example.**
 * The build feature definition contains a reference to a Jira Issue Tracker connection, which defines credentials to be used for build status reporting.
 * ```
 * features {
 *   jiraCloudIntegration {
 *     issueTrackerConnectionId = "<Jira Issue Tracker connection ID>"
 *   }
 * }
 * ```
 *
