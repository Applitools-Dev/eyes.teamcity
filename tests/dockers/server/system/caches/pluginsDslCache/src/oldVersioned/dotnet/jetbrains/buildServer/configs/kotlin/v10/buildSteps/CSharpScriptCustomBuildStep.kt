...
open class CSharpScriptCustomBuildStep : BuildStep {
    constructor(init: CSharpScriptCustomBuildStep.() -> Unit = {}, base: CSharpScriptCustomBuildStep? = null): super(base = base as BuildStep?) {
        type = "csharpScript"
 ...
 */
fun BuildSteps.csharpScript(base: CSharpScriptCustomBuildStep? = null, init: CSharpScriptCustomBuildStep.() -> Unit = {}) {
    step(CSharpScriptCustomBuildStep(init, base))
}
