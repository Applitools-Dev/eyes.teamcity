...
/**
 * Deprecated, was previously used to set up a [build step for running Visual Studio tests](https://www.jetbrains.com/help/teamcity/visual-studio-tests.html).
 ...
 * @see vstest
 */
@Deprecated("Deprecated, was previously used to set up a build step for running Visual Studio tests.", replaceWith = ReplaceWith("DotnetVsTestStep"))
open class VSTestStep : BuildStep {
    constructor(init: VSTestStep.() -> Unit = {}, base: VSTestStep? = null): super(base = base as BuildStep?) {
 ...
 */
@Deprecated("Deprecated, was previously used to set up a build step for running Visual Studio tests.", replaceWith = ReplaceWith("DotnetVsTestStep"))
fun BuildSteps.vstest(base: VSTestStep? = null, init: VSTestStep.() -> Unit = {}) {
    step(VSTestStep(init, base))
}
