...
open class NuGetPackStep : BuildStep {
    constructor(init: NuGetPackStep.() -> Unit = {}, base: NuGetPackStep? = null): super(base = base as BuildStep?) {
        type = "jb.nuget.pack"
        init()
    }
    ...
    sealed class BaseDir(value: String? = null): CompoundParam(value) {
 ...
 * @see NuGetPackStep
 */
fun BuildSteps.nuGetPack(base: NuGetPackStep? = null, init: NuGetPackStep.() -> Unit = {}) {
    step(NuGetPackStep(init, base))
}
