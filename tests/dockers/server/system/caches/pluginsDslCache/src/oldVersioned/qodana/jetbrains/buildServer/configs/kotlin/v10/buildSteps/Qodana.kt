...
open class Qodana : BuildStep {
    constructor(init: Qodana.() -> Unit = {}, base: Qodana? = null): super(base = base as BuildStep?) {
        type = "Qodana"
        init()
    }
    ...
    sealed class Linter(value: String? = null): CompoundParam(value) {
    ...
    sealed class InspectionProfile(value: String? = null): CompoundParam(value) {
 ...
 * @see Qodana
 */
fun BuildSteps.qodana(base: Qodana? = null, init: Qodana.() -> Unit = {}) {
    step(Qodana(init, base))
}
