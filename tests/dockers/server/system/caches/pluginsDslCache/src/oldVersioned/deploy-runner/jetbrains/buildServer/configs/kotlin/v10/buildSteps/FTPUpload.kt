...
open class FTPUpload : BuildStep {
    constructor(init: FTPUpload.() -> Unit = {}, base: FTPUpload? = null): super(base = base as BuildStep?) {
 ...
 * @see FTPUpload
 */
fun BuildSteps.ftpUpload(base: FTPUpload? = null, init: FTPUpload.() -> Unit = {}) {
    step(FTPUpload(init, base))
}
